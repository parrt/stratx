...
n = 1000
df, eqn = synthetic_poly_dup_data(n, p=2)
X = df.drop('y', axis=1)
y = df['y']
plot_stratpd(X, y, colname='x1', targetname='y', min_samples_leaf=5)
plot_stratpd(X, y, colname='x2', targetname='y', min_samples_leaf=5)

R = compare_top_features(X, y, n_shap=500, min_samples_leaf=10,
                         #min_slopes_per_x=n * 3.5 / n,
                         n_estimators=40,
