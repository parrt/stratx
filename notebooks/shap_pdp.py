...
def our_slope_expectation(newdata=True):
    ...
    for min_samples_leaf in [3,5,7,8,10,12,14]:
        ...
        for i in range(ntrials):
            ...
            leaf_xranges, leaf_slopes, slope_counts_at_x, dx, slope_at_x, pdpx1, pdpy1, ignored = \
                partial_dependence(X=X, y=y, colname='x1', min_samples_leaf=min_samples_leaf)
            leaf_xranges, leaf_slopes, slope_counts_at_x, dx, slope_at_x, pdpx2, pdpy2, ignored = \
                partial_dependence(X=X, y=y, colname='x2', min_samples_leaf=min_samples_leaf)
            leaf_xranges, leaf_slopes, slope_counts_at_x, dx, slope_at_x, pdpx3, pdpy3, ignored = \
