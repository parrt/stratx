...
\subcaption{\small \simp{} curve for bulldozer {\tt SalePrice} on {\tt YearMade} including the histogram used to weight the partial dependence to obtain feature importances; this plot represents a 20k subsample of 363k. Roughly 0.5\% of samples were stratified into regions with a single {\tt YearMade} value.}
\label{fig:yearmade}
\end{subfigure}
\end{figure}
