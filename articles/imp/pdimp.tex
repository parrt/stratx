...
\figref{fig:topk-impact} shows that the plain impact, unweighted by $x_j$ density, can also work well for model feature selection purposes.  The impact error curves match the importance error curves closely, indicating that $x_j$ density is not critical for these data sets.
