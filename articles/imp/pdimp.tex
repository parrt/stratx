...
\figref{fig:topk}(c) shows an unexpected result, that the top feature recommended by \simp{} gets half the error rate of the top features recommended by the other methods for the bulldozer data set. \simp{} recommends the {\tt ModelID} followed by {\tt YearMade}, whereas RF-based SHAP selects {\tt ProductSize} followed by {\tt YearMade}. \todo{tie into the importance bar charts}
