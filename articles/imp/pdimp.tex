...
default is one trial, cat min samples leaf=10, samples/leaf=20
...
\todo{ average of all category contributions to all pairs}
...
\caption[short]{\small MAE curves as in \figref{fig:topk} except measuring OLS predictions, rather than RF. Markers refer to the same techniques as in \figref{fig:topk-gbm} but were removed to avoid legend overlap.}
\label{fig:OLS}
\end{center}
\end{figure}
...
\hline
{\tt\small flight} & 17 & 5 & 0.4s & 9.3s & 23.8s & 42.2s & {\small $0.771 n + 0.023 n^2$} & {\small 0.9991}\\
{\tt\small bulldozer} & 14 & 2 & 0.2s & 2.6s & 9.1s & 14.7s & {\small $0.180 n + 0.010 n^2$} & {\small 0.9953}\\
{\tt\small rent} & 20 & 0 & 0.3s & 3.5s & 7.7s & 12.1s & {\small $0.363 n + 0.002 n^2$} & {\small 0.9990}\\
\end{tabular}
