...
\begin{subfigure}{.24\textwidth}
    \centering
\includegraphics[scale=0.5]{images/boston-topk.pdf}
\subcaption{\footnotesize foo}
\end{subfigure}%
\hfill
\begin{subfigure}{.25\textwidth}
    \centering
\includegraphics[scale=0.53]{images/flights-topk.pdf}
\subcaption{\footnotesize foo}
\end{subfigure}
\hfill
\begin{subfigure}{.25\textwidth}
    \centering
\includegraphics[scale=0.52]{images/bulldozer-topk.pdf}
\subcaption{\footnotesize foo}
\end{subfigure}%
\hfill
\begin{subfigure}{.24\textwidth}
    \centering
\includegraphics[scale=0.51]{images/rent-topk.pdf}
\subcaption{\footnotesize foo}
\end{subfigure}
