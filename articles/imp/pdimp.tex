...
The bulldozer data set results, \figref{fig:topk}(c), surprised us because the top feature recommended by \simp{} gets half the error rate of the top features recommended by the other methods. One would expect model-based techniques to easily identify the single most important model feature.


 \simp{} recommends the {\tt ModelID} followed by {\tt YearMade}, whereas RF-based SHAP selects {\tt ProductSize} followed by {\tt YearMade}. \todo{tie into the importance bar charts}
