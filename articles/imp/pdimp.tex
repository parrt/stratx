...
\todo{this is all in stratpd paper}
...
~\\
\noindent {\bf Definition 1} The {\em ideal partial dependence} of $y$ on feature $x_j$ for continuous and smooth generator function $f:\mathbb{R}^{p} \rightarrow \mathbb{R}$ evaluated at $x_j = z$ is the cumulative sum up to $z$:
