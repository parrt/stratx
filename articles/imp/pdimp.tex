...
\begin{subfigure}{.5\textwidth}
    \centering
\includegraphics[scale=0.7]{images/boston-topk-spearman.pdf}
\vspace{-2mm}\subcaption{\footnotesize foo}\vspace{3mm}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
    \centering
\includegraphics[scale=0.7]{images/flights-topk-spearman.pdf}
\vspace{-2mm}\subcaption{\footnotesize foo}\vspace{3mm}
\end{subfigure}
...
\begin{subfigure}{.5\textwidth}
    \centering
\includegraphics[scale=0.6]{images/boston-topk.pdf}
\vspace{-2mm}\subcaption{\footnotesize foo}\vspace{3mm}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
    \centering
\includegraphics[scale=0.6]{images/flights-topk.pdf}
\vspace{-2mm}\subcaption{\footnotesize foo}\vspace{3mm}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
    \centering
\includegraphics[scale=0.6]{images/bulldozer-topk.pdf}
\vspace{-2mm}\subcaption{\footnotesize foo}\vspace{3mm}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
    \centering
\includegraphics[scale=0.6]{images/rent-topk.pdf}
\vspace{-2mm}\subcaption{\footnotesize foo}\vspace{3mm}
\end{subfigure}
