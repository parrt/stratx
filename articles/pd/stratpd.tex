\documentclass[]{article} % for PREPRINT
\usepackage{natbib}
...
The SHAP method from \citet{shap} has roots in {\em Shapley regression values} \citep{shapley-regression} and calculates the average marginal effect of adding $x_j$ to models, \todo{$\hat{f}_S$}, trained on all possible subsets of features:
\vspace{-1mm}
