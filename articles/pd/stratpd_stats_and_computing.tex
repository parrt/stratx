...
\caption{\small Partial dependence curves of bulldozer {\tt MachineHours} versus {\tt SalePrice} for FPD/ICE, SHAP, ALE, and \spd. $n$=20,000 observations drawn from \textasciitilde{}362k. Same model, setup as in \figref{fig:yearmade}. 4945 out of 10000 records have missing machine hours.  The spike in {\tt MachineHours} density at 3138 hours is the imputed median. The \spd{} dots are the average of 10 bootstrapped trials and more dots implies more records with that $x_j$ value.}
